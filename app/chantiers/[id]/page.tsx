      ...
      <div className="max-w-6xl mx-auto px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold text-gray-900">
                  Photos
                  <span className="ml-1.5 text-gray-400 font-normal">({chantier._count.photos})</span>
                </h2>
              </div>
              <Link
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-4">Client</h2>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-4">Adresse</h2>
            <div className="flex items-start gap-2.5">
              <MapPin size={13} className="text-gray-400 mt-0.5 shrink-0" />
              <div>
                <p className="text-sm text-gray-700">{chantier.adresse.rue} {chantier.adresse.numero}</p>
                <p className="text-sm text-gray-500">{chantier.adresse.codePostal} {chantier.adresse.ville}</p>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-4">Planification</h2>
            <div className="space-y-3">
              <div className="flex items-center gap-2.5">
